...
export class ToolhubDocumentConvert implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolhub Document Convert',
		name: 'toolhubDocumentConvert',
		icon: 'fa:file',
		group: ['transform'],
		version: 1,
		description: 'Convert documents through Toolhub run-file',
		defaults: {
			name: 'Toolhub Document Convert',
		},
		inputs: ['main'],
		outputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		return executeFileToolNode(this, { toolAlias: 'n8n_document_convert' });
	}
}
