...
export class ToolhubXlsxRead implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolhub XLSX Read',
		name: 'toolhubXlsxRead',
		icon: 'fa:file',
		group: ['transform'],
		version: 1,
		description: 'Read XLSX files through Toolhub run-file',
		defaults: {
			name: 'Toolhub XLSX Read',
		},
		inputs: ['main'],
		outputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		return executeFileToolNode(this, { toolAlias: 'n8n_xlsx_read' });
	}
}
