...
export class ToolhubImageConvert implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolhub Image Convert',
		name: 'toolhubImageConvert',
		icon: 'fa:file',
		group: ['transform'],
		version: 1,
		description: 'Convert images through Toolhub run-file',
		defaults: {
			name: 'Toolhub Image Convert',
		},
		inputs: ['main'],
		outputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		return executeFileToolNode(this, { toolAlias: 'n8n_image_convert' });
	}
}
