...
export class ToolhubGifOptimize implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolhub GIF Optimize',
		name: 'toolhubGifOptimize',
		icon: 'fa:file',
		group: ['transform'],
		version: 1,
		description: 'Optimize GIF files through Toolhub run-file',
		defaults: {
			name: 'Toolhub GIF Optimize',
		},
		inputs: ['main'],
		outputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		return executeFileToolNode(this, { toolAlias: 'n8n_gif_optimize' });
	}
}
