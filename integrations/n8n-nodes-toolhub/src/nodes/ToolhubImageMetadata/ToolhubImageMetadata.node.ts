...
export class ToolhubImageMetadata implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Toolhub Image Metadata',
		name: 'toolhubImageMetadata',
		icon: 'fa:file',
		group: ['transform'],
		version: 1,
		description: 'Extract image metadata through Toolhub run-file',
		defaults: {
			name: 'Toolhub Image Metadata',
		},
		inputs: ['main'],
		outputs: ['main'],
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		return executeFileToolNode(this, { toolAlias: 'n8n_image_metadata' });
	}
}
